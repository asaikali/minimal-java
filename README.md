...
2. **[Part 2 — A smaller, better-layered image](docs/2-layering.md)**
...
| `minimal-java/ubuntu`     | `scratch` | Canonical **chisel** — package *slices*, no shell/apt    | ~2.5 MB      | —       | [2](docs/2-layering.md) |
| `minimal-java/jre`        | `ubuntu`  | **trimmed Temurin JRE 25** — launchers removed           | ~65 MB       | —       | [2](docs/2-layering.md) |
| `minimal-java/app`        | `jre`     | Spring Boot **layered jar**, exploded into cache layers  | ~119 MB      | ~1.6 s  | [2](docs/2-layering.md) |
...
```
  BASE IMAGES   images/{ubuntu,jre}  ──▶  ghcr base layer        (Part 2)
  ARTIFACT      mvn package + oras   ──▶  ghcr.io/…/jar           (Part 1)
  CONTAINERIZE  images/{fat,app,…}   ──▶  ghcr.io/…/<name>        (each part)
```
