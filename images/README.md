...
| [`2-size/`](2-size) | `golden-ubuntu`, `golden-jre`, `app` | chiseled base, trimmed JRE, layered jar — make it **smaller** | [Part 2](../docs/2-size.md) |
...
The base images (`golden-ubuntu`, `golden-jre`) are built by the
